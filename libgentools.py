...
class SearchRequest:
    ...
    def create_entry_list(self, table):
        """Create and return a list of entries as a new Results object.
        ...
        Results
            ...
            the new instance uses the list of standard entry
            dictionaries generated by this method as a parameter.
        """
        ...
        for row in table:
            ...
            # Adding entry to the list of standard entry dictionaries
...
class Results:
    ...
    def __init__(self, results):
        ...
        ----------
        results : list
            A list of standard entry dictionaries, returned either by
